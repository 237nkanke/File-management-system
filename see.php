        ...
        <div class="" id="folder" style="margin-top: 20px;">
            <div class="">
                ...
                if(isset($_SESSION['pdf']))
                    {
                       $query = "SELECT * FROM file WHERE id = '".mysqli_real_escape_string($link,$_SESSION['pdf'])."'";
                ...
                if(isset($_SESSION['pdf']))
                    {
                       ...
                       if(isset($row)){
                        ...
                        {
                        ?>
                        <embed type="application/pdf" src="pdf/<?php echo $row['name'] ; ?>" width="1100" height="520">
                        <?php
                        }elseif($row['type'] = 'word')
                        {
                            ?>
                                <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=pdf/<?php echo $row['name'] ; ?>' width='100%' height='650px' frameborder='0'></iframe>
                            <?php
                        }
                       }
                    }
